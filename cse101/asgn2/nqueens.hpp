...
public:
  ...
  bool insert(int i, int k);    // insert a queen to the given place, return true if success
  ...
  bool now_valid();             // return whether the board is valid for now
  bool find();                  // find all the solutions and fill in the list, return true if find solutions
  void ptr_copy(int *, int *);  // deep copy the two pointer, used for find()
