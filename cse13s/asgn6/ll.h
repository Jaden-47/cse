...
// node_travek: counter for nodes travel when seeking a key
// seeks: counter for everytime using ll_lookup()
extern double nodes_travel;
extern int seeks;

//
// Struct definiition of a HatterSpeak
//
// oldspeak: words that need to translate or abandon
// hatterspeak: translation of oldspeak
//
